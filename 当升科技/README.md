...
This subproject lives inside the broader `股市预测` repository and applies the `lecture6` ETL + ML assignment pattern to `北京当升材料科技股份有限公司 (300073)`.
...
```bash
docker build -t easpring-dashboard ./当升科技
