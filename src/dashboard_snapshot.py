    ...
    return dedent(
        ...
        const I18N = {
          zh: {
            ...
            "modelName.random_forest_selected": "随机森林(筛选后特征)",
          ...
          en: {
            ...
            "modelName.logistic": "Logistic Regression",
            "modelName.random_forest": "Random Forest",
            "modelName.random_forest_selected": "Random Forest (selected features)",
          ...
          de: {
            ...
            "modelName.random_forest": "Random Forest",
            "modelName.random_forest_selected": "Random Forest (ausgewählte Merkmale)",
